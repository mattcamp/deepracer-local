...
job_name = s3_prefix = os.environ.get("MODEL_S3_PREFIX")
...
model_metadata_s3_key = "s3://{}/{}".format(s3_bucket, os.environ.get('MODEL_METADATA_FILE_S3_KEY',
...
hyperparameters = {"s3_bucket": s3_bucket,
                   ...
                   "batch_size": os.environ.get('HP_BATCH_SIZE', 64),
                   "beta_entropy": os.environ.get('HP_ENTROPY', 0.01),
                   "discount_factor": os.environ.get('HP_DISCOUNT', 0.999),
                   "e_greedy_value": 0.05,
                   "epsilon_steps": 10000,
                   "exploration_type": "categorical",
                   "loss_type": os.environ.get('HP_LOSS_TYPE', "mean squared error"),
                   "lr": os.environ.get('HP_LEARNING_RATE', 0.0003),
                   "num_episodes_between_training": os.environ.get('HP_EPISODES_BETWEEN_TRAINING', 20),
                   "num_epochs": os.environ.get('HP_EPOCHS', 10),
                   "stack_size": 1,
...
pretrained_model = os.environ.get('PRETRAINED_MODEL', None)
if pretrained_model:
    hyperparameters['pretrained_s3_bucket'] = "{}".format(s3_bucket)
    hyperparameters['pretrained_s3_prefix'] = "{}".format(pretrained_model)
